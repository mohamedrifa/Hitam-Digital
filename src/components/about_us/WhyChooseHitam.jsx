  ...
  return (
    <section className="bg-white text-[#1B1B1B]">
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 md:px-8 lg:px-12">
        {/* Title */}
        <Reveal as="h2">
          <h2 className="text-xl leading-tight font-extrabold tracking-tight text-[#1d2b1c] sm:text-2xl md:text-3xl">
        ...
        <div className="mt-6 grid grid-cols-1 items-start gap-6 md:grid-cols-2 md:gap-8 lg:gap-10">
          ...
          <Reveal as="div" delay={80}>
            <div className="space-y-4 text-[13.5px] leading-6 text-[#333]">
              <p>
...
function FeatureCard({ title, text, href }) {
  return (
    <div className="group rounded-xl border border-black/5 bg-[#FFFCEB] p-5 shadow-sm transition will-change-transform hover:-translate-y-0.5 hover:shadow-md">
      <h4 className="inline-block rounded-full bg-[#F5F0C8] px-3 py-1 text-[12px] font-semibold text-[#2b2b2b]">
        {title}
      </h4>
      <p className="mt-3 min-h-[88px] text-[14px] leading-6 text-[#4a4a4a]">{text}</p>
